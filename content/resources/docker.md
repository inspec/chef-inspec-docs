...
[menu.resources]
    title = "docker"
    identifier = "resources/os/docker.md docker resource"
    parent = "resources/os"
+++

Use the `docker` Chef InSpec audit resource to test configuration data for the Docker daemon. It is a very comprehensive resource. See also: [docker_container](/resources/docker_container/) and [docker_image](/resources/docker_image/), too.
