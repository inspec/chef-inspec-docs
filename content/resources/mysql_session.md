...
[menu.resources]
    title = "mysql_session"
    identifier = "resources/os/mysql_session.md mysql_session resource"
    parent = "resources/os"
+++
...
This Chef InSpec audit resource builds a [command](/resources/command) object and returns the the result object. {{< readfile file="content/reusable/md/inspec_matchers_link.md" >}}
