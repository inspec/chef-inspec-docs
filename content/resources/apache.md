...
[menu.resources]
    title = "apache"
    identifier = "resources/os/apache.md apache resource"
    parent = "resources/os"
+++

{{< warning >}}

This resource is deprecated and should not be used. It was removed in Chef InSpec 4.0. The documentation below is preserved as a reference. Replacement functionality is available in the [`apache_conf`](/resources/apache_conf/) resource.
