...
[menu.resources]
    title = "parse_config"
    identifier = "resources/os/parse_config.md parse_config resource"
    parent = "resources/os"
+++
...
This resource is based on the `parse_config_file` resource. See the [`parse_config_file`](/resources/parse_config_file) resource for examples.
